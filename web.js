...
// const authToken = 'a73a54128ecdd7b068da985114601aa2';
...
cron.schedule('*/1 * * * *', async () => {
  try {
    ...
    for (const reservation of reservationsToNotify) {
      ...
      const message = `[Tripcam 예약 안내] 
안녕하세요, ${reservation.name} 고객님.
Tripcam 최종 예약이 완료되었습니다.

트립캠을 통해 즐거운 여행하시길 바라며, 더 나은 서비스로 보답하는 트립캠이 되도록 노력하겠습니다.

카카오톡 채널 후기 작성해주시면 최대 "10,000원" 페이백 이벤트 진행중이니 많은 관심 부탁드립니다. 

▷예약 관련 변경 및 취소 
01030966033 으로 연락 부탁드립니다.

▷카카오톡 :  pf.kakao.com/_vmzuG
